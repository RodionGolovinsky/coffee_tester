...
model_path_quality = os.path.join(current_path, 'models', 'models_quality', f'catboost_{electrode}.bin')
model_path_acidity = os.path.join(current_path, 'models', 'models_taste', f'catboost_acidity_{electrode}.bin')
model_path_bitterness = os.path.join(current_path,  'models', 'models_taste', f'catboost_bitterness_{electrode}.bin')
model_path_sweetness = os.path.join(current_path,  'models', 'models_taste', f'catboost_sweetness_{electrode}.bin')
...
with open(f'models{os.sep}scaler.pkl', 'rb') as f:
